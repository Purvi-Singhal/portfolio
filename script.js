...
(function () {
  ...
  var EMAILJS_PUBLIC_KEY = 'Vz15KgeUKz9y8tNLc';       // e.g. 'aBcDeFgHiJkLm'
  var EMAILJS_SERVICE_ID = 'service_ldme9li';       // e.g. 'service_gmail'
  var EMAILJS_TEMPLATE_ID = 'template_7y5e2ha';     // e.g. 'template_contact'
  ...
  var toastIcon = document.getElementById('contactToastIcon');
  var toastTitle = document.getElementById('contactToastTitle');
  var toastDesc = document.getElementById('contactToastDesc');
  ...
  form.addEventListener('submit', function (e) {
    ...
    // Basic check: are credentials set?
    if (EMAILJS_PUBLIC_KEY === 'YOUR_PUBLIC_KEY' ||
      EMAILJS_SERVICE_ID === 'YOUR_SERVICE_ID' ||
      EMAILJS_TEMPLATE_ID === 'YOUR_TEMPLATE_ID') {
      showToast('error', 'Setup Required',
        'EmailJS credentials not configured. Please see script.js for setup instructions.');
      return;
    }
    ...
    emailjs.send(EMAILJS_SERVICE_ID, EMAILJS_TEMPLATE_ID, {
      ...
      showToast('success', 'Message Sent! ✨',
        "Your message has been delivered. I'll respond within 24–48 hours.");
      ...
      showToast('error', 'Delivery Failed',
